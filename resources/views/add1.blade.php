...
<body>
                            ...
                            <div class="mb-4">
                                ...
                                <sapn class="red">*</span>
                                    <select name="serviceProvider" id="serviceProvider" class="form-control">
                                        ...
                                        <option  hidden="hidden" value="{{$editData['0']->provider_name}}">{{$editData['0']->provider_name}}</option>
                        ...
                        <div class="col-md-6">
                            <div class="mb-4">
                                ...
                                <sapn class="red">*</span>
                                    ...
                                    <option hidden="hidden" value="{{$editData['0']->connection_speed}}">{{$editData['0']->connection_speed}}</option>
                                    </select>
                            </div>
                        </div>
                    </div>
                    <fieldset class="rounded border border-secondary p-2">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <sapn class="red">*</span>
                                    <input type="hidden" value="{{$editData['0']->registration_id}}" name="id"/>
                                        <input type="text" class="form-control" id="app_name" name="app_name" placeholder="Applicant Name" value="{{$editData['0']->applicant_name}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <sapn class="red">*</span>
                                        <input type="email" class="form-control" id="email" name="email" placeholder="Email ID" value="{{$editData['0']->email_id}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <sapn class="red">*</span>
                                        <input type="text" class="form-control" id="mobile" name="mobile" placeholder="Mobile No" value="{{$editData['0']->mobile_number}}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <sapn class="red">*</span>
                                        <input type="text" class="form-control datepicker" id="dob" name="dob" placeholder="Date of Birth" autocomplete="off" onchange=dateValidate(); value="{{$editData['0']->dob}}">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="file" name="docs" id="docs" class="form-control validate" onchange="readURL(this);" value="{{$editData['0']->imgae_path}}">
                        ...
                        <div class="row">
                            <div class="col-md-3 mx-auto">
                                <button type="submit" class="btn btn-success" name="btn" id="btnSubmit">Update</button>
    ...
    <script>
        ...
        function dateValidate() {
            ...
            $('#hdnAge').val(age);
            if (age < 12) {
                successAlerts("Not Valid!", "Age must be greater than 12", "error");
                $('#dob').val('');
                $('#hdnAge').val('');
            } else {
                return true
...
<script>            
            $("#serviceProvider").change(function() {  
                ...
                $.ajax({
                    url: "{{url('api/fetch-provider')}}", 
                    type: "POST", 
                    dataType: "JSON", 
                    data: {'_token': '{{csrf_token()}}', providerId: serviceProvider}, 
        ...
        $('#btnSubmit').click(function() {
            $('#res').validate({
                ...
                submitHandler: function(form) {
                    Swal.fire("Your Data Update", "Check Your Status", "success");
                    form.submit();
                }
            });
        });
        ...
        $(document).ready(function() {
            ...
            $('#res').submit(function(e) {
                ...
                if (serviceProvider.length < 1) {
                    ...
                    Swal.fire("Your Data Updated", "Check Your Status", "success");
                }
...
function myFunction() {
  ...
  document.getElementById("hdnAge").value = age;
}
